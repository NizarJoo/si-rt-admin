...
import NewYearForm from "./new-form";
  ...
  const fetchYear = async () => {
    try {
      const response = await a.get(
        `${API_URL}/auth/dashboard/classes/academic-year`,
      );
    ...
    <div className="w-full space-y-4">
      <div className="flex items-center">
        <Input
          ...
          value={table.getColumn("academic_year")?.getFilterValue() ?? ""}
          onChange={(e) =>
            table.getColumn("academic_year")?.setFilterValue(e.target.value)
          }
          className="max-w-sm"
        />
      </div>
